...
const MILESTONES = [
  {
    count: 3,
    title: "პირველი ეტაპი: შენი სისვეჟის ეტაპი :))",
    message:
  ...
  {
    count: 6,
    title: "მეორე ეტაპი: სულ რო მახსოვხარ ის ეტაპი :))",
    message:
  ...
  {
    count: 9,
    title: "მესამე ეტაპი: ეტაპი სადაც ყველაფერს მიაღწევ :))",
    message:
  ...
  {
    count: 12,
    title: "მეოთხე ეტაპი: შენი კეთილშობილების ეტაპი :))",
    message:
      "ვახხ აქამდეც მოხვედიიიი?? მინდა იცოდე რო შენი კეთილშობილი გულით სხვებსაც აკეთილშობილებ, იმენა ანათებ სვეჟ. შენზე რო ვფიქრობ სულ მეღიმება. ადამინებს რადიკალურად ცვლი შენი საოცარი პიროვნულობით. ცხოვრებაში ცუდი ნათქვამი არავიზე გაქ ჩემ თვალ წინ! მართლა უკეთეს ადამიანად მაქციე ვიდრე ვიყავი!",
  },
  {
    count: 15,
    title: "მეხტუთე ეტაპი: მადლიერების ეტაპი :))",
    message:
      "მეხუთე ეტაპზე ხარ ანანო, ამ ეტაპზე მინდა მადლობა გითხრა ვაბშე ყველაფრისთვის",
  },
  {
    count: 18,
    title: "მეექვსე ეტაპი: სინანულის ეტაპი :))",
    message:
